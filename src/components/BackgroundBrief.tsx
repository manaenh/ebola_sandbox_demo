  ...
  return (
    <div className="briefing-page">
      <header className="briefing-hero">
        <div>
          <span className="real-world-badge">真实疫情背景 <small>REAL-WORLD CONTEXT</small></span>
      ...
      <section className="briefing-content-grid">
        <article className="brief-card">
          <span className="eyebrow"><b>疾病特征</b><small>DISEASE PROFILE</small></span><h2>必须被正确理解的传播边界</h2>
