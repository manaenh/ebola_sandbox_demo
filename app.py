...
# Protect returning Cloud sessions from stale or invalid widget state.
st.session_state.simulation_day = int(
    np.clip(st.session_state.get("simulation_day", DAYS), 1, DAYS)
)
for key in ALL_KEYS:
